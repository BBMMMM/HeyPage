    ...
    for (let i = 0; i < 6; i++) {
        ...
        for (let j = 0; j < 7; j++) {
            if ((i === 0 && j < firstDay - 1) || date > daysInMonth) {
                ...
                cell.style.backgroundColor = isWeekend ? weekendBackgroundColor : weekdayBackgroundColor;
                ...
                cell.addEventListener("mouseleave", function () {
                    cell.style.backgroundColor = isWeekend ? weekendBackgroundColor : weekdayBackgroundColor; // Reset to original background color
                });
